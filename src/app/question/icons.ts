export default [
  ...
  },
  {
    name: 'javascript',
    tags: ['programming', 'language'],
    versions: { svg: ['original', 'plain'], font: ['plain'] }
  },
  {
    name: 'jquery',
  ...
  },
  {
    ...
    versions: { svg: ['plain-wordmark'], font: ['plain-wordmark'] }
  },
  {
    name: 'linux',
    tags: ['os'],
  ...
  },
  {
    name: 'photoshop',
    tags: ['editor', 'graphic'],
    versions: { svg: ['plain', 'line'], font: ['plain', 'line'] }
  },
  {
    name: 'php',
    tags: ['programming', 'language'],
